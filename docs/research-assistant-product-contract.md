...
Detailed machine contracts: [`knowledge-artifact-contract.md`](knowledge-artifact-contract.md), [`claim-evidence-currentness.md`](claim-evidence-currentness.md), [`research-relations.md`](research-relations.md), and [`claim-lifecycle.md`](claim-lifecycle.md).
